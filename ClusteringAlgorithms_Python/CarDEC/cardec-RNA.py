...
x = pd.read_csv(Benchamark_data_path+'/RNACount.csv', header=0, index_col=0).T.values
...
CarDEC = CarDEC_API(adata, weights_dir = save_dir, n_high_var = 2000, LVG = True)
