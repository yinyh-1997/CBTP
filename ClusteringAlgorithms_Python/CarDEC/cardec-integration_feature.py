...
CarDEC = CarDEC_API(adata, weights_dir = save_dir, n_high_var = None, preprocess=False, normalize_samples=False, log_normalize = False, normalize_features = False)
...
method_name = "CarDEC-integration_feature"
